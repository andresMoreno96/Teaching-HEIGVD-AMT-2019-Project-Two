Feature: Suppression of a Quest
  ...
  Scenario: delete a Quest
    ...
    And the already existing quest "slayer Dragon 1" with the objective of "killing"
    When I DELETE  into the /quests endpoint
    Then I receive a 200 status code

  Scenario: delete an in-existent Quest
    Given the adventurer
    And the already existing quest "slayer Dragon 2" with the objective of "killing"
    When I DELETE  into the /quests endpoint
  ...
  Scenario: invalid token
    ...
    Given the adventurer
    And the already existing quest "slayer Dragon 3" with the objective of "killing"
    When I DELETE  into the /quests endpoint
